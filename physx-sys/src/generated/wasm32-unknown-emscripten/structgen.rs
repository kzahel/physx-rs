...
pub struct PxBroadcastingAllocator {
    pub structgen_pad0: [u8; 92],
}
#[derive(Clone, Copy)]
#[cfg_attr(feature = "debug-structs", derive(Debug))]
#[repr(C)]
pub struct PxBroadcastingErrorCallback {
    pub structgen_pad0: [u8; 84],
}
#[derive(Clone, Copy)]
#[cfg_attr(feature = "debug-structs", derive(Debug))]
#[repr(C)]
...
mod sizes {
    ...
    fn check_sizes() {
        ...
        assert_eq!(size_of::<PxBroadcastingAllocator>(), 92);
        assert_eq!(size_of::<PxBroadcastingErrorCallback>(), 84);
        ...
        assert_eq!(size_of::<PxReadWriteLock>(), 4);
        assert_eq!(size_of::<PxProfileScoped>(), 32);
        assert_eq!(size_of::<PxSListEntry>(), 8);
        ...
        assert_eq!(size_of::<PxStridedData>(), 8);
        assert_eq!(size_of::<PxBoundedData>(), 12);
        assert_eq!(size_of::<PxDebugPoint>(), 16);
        assert_eq!(size_of::<PxDebugLine>(), 32);
        assert_eq!(size_of::<PxDebugTriangle>(), 48);
        assert_eq!(size_of::<PxDebugText>(), 24);
        assert_eq!(size_of::<PxDeserializationContext>(), 8);
        assert_eq!(size_of::<PxBase>(), 12);
        assert_eq!(size_of::<PxRefCounted>(), 12);
        assert_eq!(size_of::<PxTolerancesScale>(), 8);
        assert_eq!(size_of::<PxMetaDataEntry>(), 32);
        assert_eq!(size_of::<PxBaseTask>(), 24);
        assert_eq!(size_of::<PxTask>(), 24);
        assert_eq!(size_of::<PxLightCpuTask>(), 32);
        assert_eq!(size_of::<PxGeometry>(), 8);
        assert_eq!(size_of::<PxBoxGeometry>(), 20);
        assert_eq!(size_of::<PxBVH>(), 12);
        assert_eq!(size_of::<PxCapsuleGeometry>(), 16);
        assert_eq!(size_of::<PxHullPolygon>(), 20);
        assert_eq!(size_of::<PxConvexMesh>(), 12);
        assert_eq!(size_of::<PxMeshScale>(), 28);
        assert_eq!(size_of::<PxConvexMeshGeometry>(), 44);
        assert_eq!(size_of::<PxSphereGeometry>(), 12);
        assert_eq!(size_of::<PxPlaneGeometry>(), 8);
        assert_eq!(size_of::<PxTriangleMeshGeometry>(), 44);
        assert_eq!(size_of::<PxHeightFieldGeometry>(), 28);
        assert_eq!(size_of::<PxParticleSystemGeometry>(), 12);
        assert_eq!(size_of::<PxHairSystemGeometry>(), 8);
        assert_eq!(size_of::<PxTetrahedronMeshGeometry>(), 12);
        ...
        assert_eq!(size_of::<PxCustomGeometry>(), 12);
        assert_eq!(size_of::<PxGeometryHolder>(), 44);
        assert_eq!(size_of::<PxGeometryQuery>(), 1);
        assert_eq!(size_of::<PxHeightFieldSample>(), 4);
        assert_eq!(size_of::<PxHeightField>(), 12);
        assert_eq!(size_of::<PxHeightFieldDesc>(), 28);
        assert_eq!(size_of::<PxMeshQuery>(), 1);
        assert_eq!(size_of::<PxSimpleTriangleMesh>(), 28);
        assert_eq!(size_of::<PxTriangle>(), 36);
        assert_eq!(size_of::<PxTrianglePadded>(), 40);
        assert_eq!(size_of::<PxTriangleMesh>(), 12);
        assert_eq!(size_of::<PxBVH34TriangleMesh>(), 12);
        assert_eq!(size_of::<PxTetrahedron>(), 48);
        assert_eq!(size_of::<PxSoftBodyAuxData>(), 12);
        assert_eq!(size_of::<PxTetrahedronMesh>(), 12);
        assert_eq!(size_of::<PxSoftBodyMesh>(), 12);
        assert_eq!(size_of::<PxCollisionMeshMappingData>(), 4);
        ...
        assert_eq!(size_of::<PxCollisionTetrahedronMeshData>(), 4);
        assert_eq!(size_of::<PxSimulationTetrahedronMeshData>(), 4);
        assert_eq!(size_of::<PxActor>(), 16);
        assert_eq!(size_of::<PxAggregate>(), 16);
        ...
        assert_eq!(size_of::<PxSolverConstraintDesc>(), 48);
        assert_eq!(size_of::<PxSolverConstraintPrepDescBase>(), 112);
        assert_eq!(size_of::<PxSolverConstraintPrepDesc>(), 160);
        assert_eq!(size_of::<PxSolverContactDesc>(), 160);
        ...
        assert_eq!(size_of::<PxTGSSolverConstraintPrepDescBase>(), 112);
        assert_eq!(size_of::<PxTGSSolverConstraintPrepDesc>(), 192);
        assert_eq!(size_of::<PxTGSSolverContactDesc>(), 176);
        assert_eq!(size_of::<PxArticulationTendonLimit>(), 8);
        assert_eq!(size_of::<PxArticulationAttachment>(), 16);
        assert_eq!(size_of::<PxArticulationTendonJoint>(), 16);
        assert_eq!(size_of::<PxArticulationTendon>(), 16);
        assert_eq!(size_of::<PxArticulationSpatialTendon>(), 16);
        assert_eq!(size_of::<PxArticulationFixedTendon>(), 16);
        assert_eq!(size_of::<PxSpatialForce>(), 32);
        assert_eq!(size_of::<PxSpatialVelocity>(), 32);
        assert_eq!(size_of::<PxArticulationRootLinkData>(), 76);
        assert_eq!(size_of::<PxArticulationCache>(), 68);
        assert_eq!(size_of::<PxArticulationSensor>(), 16);
        assert_eq!(size_of::<PxArticulationReducedCoordinate>(), 16);
        assert_eq!(size_of::<PxArticulationJointReducedCoordinate>(), 16);
        assert_eq!(size_of::<PxShape>(), 16);
        assert_eq!(size_of::<PxRigidActor>(), 16);
        assert_eq!(size_of::<PxNodeIndex>(), 8);
        assert_eq!(size_of::<PxRigidBody>(), 16);
        assert_eq!(size_of::<PxArticulationLink>(), 16);
        assert_eq!(size_of::<PxConeLimitedConstraint>(), 24);
        assert_eq!(size_of::<PxConeLimitParams>(), 32);
        assert_eq!(size_of::<PxConstraintShaderTable>(), 16);
        assert_eq!(size_of::<PxConstraint>(), 16);
        ...
        assert_eq!(size_of::<PxContactStreamIterator>(), 64);
        assert_eq!(size_of::<PxGpuContactPair>(), 56);
        assert_eq!(size_of::<PxContactSet>(), 8);
        assert_eq!(size_of::<PxContactModifyPair>(), 80);
        assert_eq!(size_of::<PxBaseMaterial>(), 16);
        assert_eq!(size_of::<PxFEMMaterial>(), 16);
        assert_eq!(size_of::<PxFilterData>(), 16);
        assert_eq!(size_of::<PxParticleRigidFilterPair>(), 16);
        assert_eq!(size_of::<PxMaterial>(), 16);
        ...
        assert_eq!(size_of::<PxParticleMaterial>(), 16);
        assert_eq!(size_of::<PxActorShape>(), 8);
        assert_eq!(size_of::<PxRaycastHit>(), 52);
        assert_eq!(size_of::<PxOverlapHit>(), 12);
        assert_eq!(size_of::<PxSweepHit>(), 44);
        assert_eq!(size_of::<PxRaycastCallback>(), 72);
        assert_eq!(size_of::<PxOverlapCallback>(), 32);
        assert_eq!(size_of::<PxSweepCallback>(), 64);
        assert_eq!(size_of::<PxRaycastBuffer>(), 72);
        assert_eq!(size_of::<PxOverlapBuffer>(), 32);
        assert_eq!(size_of::<PxSweepBuffer>(), 64);
        assert_eq!(size_of::<PxQueryCache>(), 12);
        assert_eq!(size_of::<PxQueryFilterData>(), 20);
        assert_eq!(size_of::<PxRigidDynamic>(), 16);
        assert_eq!(size_of::<PxRigidStatic>(), 16);
        assert_eq!(size_of::<PxSceneQueryDesc>(), 36);
        assert_eq!(size_of::<PxBroadPhaseRegion>(), 28);
        assert_eq!(size_of::<PxBroadPhaseRegionInfo>(), 40);
        assert_eq!(size_of::<PxBroadPhaseCaps>(), 4);
        assert_eq!(size_of::<PxBroadPhaseDesc>(), 32);
        assert_eq!(size_of::<PxBroadPhaseUpdateData>(), 40);
        assert_eq!(size_of::<PxBroadPhasePair>(), 8);
        assert_eq!(size_of::<PxBroadPhaseResults>(), 16);
        assert_eq!(size_of::<PxSceneLimits>(), 32);
        assert_eq!(size_of::<PxgDynamicsMemoryConfig>(), 48);
        assert_eq!(size_of::<PxSceneDesc>(), 300);
        assert_eq!(size_of::<PxSimulationStatistics>(), 2232);
        assert_eq!(size_of::<PxGpuBodyData>(), 64);
        assert_eq!(size_of::<PxGpuActorPair>(), 16);
        assert_eq!(size_of::<PxIndexDataPair>(), 8);
        assert_eq!(size_of::<PxDominanceGroupPair>(), 2);
        assert_eq!(size_of::<PxScene>(), 8);
        assert_eq!(size_of::<PxSceneReadLock>(), 4);
        assert_eq!(size_of::<PxSceneWriteLock>(), 4);
        ...
        assert_eq!(size_of::<PxContactPairExtraDataIterator>(), 24);
        assert_eq!(size_of::<PxContactPairHeader>(), 24);
        assert_eq!(size_of::<PxContactPairPoint>(), 48);
        assert_eq!(size_of::<PxContactPair>(), 40);
        assert_eq!(size_of::<PxTriggerPair>(), 24);
        assert_eq!(size_of::<PxConstraintInfo>(), 12);
        assert_eq!(size_of::<PxFEMParameters>(), 24);
        assert_eq!(size_of::<PxPruningStructure>(), 12);
        assert_eq!(size_of::<PxExtendedVec3>(), 24);
        assert_eq!(size_of::<PxObstacle>(), 48);
        assert_eq!(size_of::<PxBoxObstacle>(), 64);
        assert_eq!(size_of::<PxCapsuleObstacle>(), 56);
        assert_eq!(size_of::<PxControllerState>(), 32);
        assert_eq!(size_of::<PxControllerStats>(), 8);
        assert_eq!(size_of::<PxControllerHit>(), 64);
        assert_eq!(size_of::<PxControllerShapeHit>(), 72);
        assert_eq!(size_of::<PxControllersHit>(), 64);
        assert_eq!(size_of::<PxControllerObstacleHit>(), 64);
        assert_eq!(size_of::<PxControllerFilters>(), 16);
        assert_eq!(size_of::<PxControllerDesc>(), 104);
        assert_eq!(size_of::<PxBoxControllerDesc>(), 120);
        assert_eq!(size_of::<PxCapsuleControllerDesc>(), 120);
        assert_eq!(size_of::<PxDim3>(), 12);
        assert_eq!(size_of::<PxSDFDesc>(), 124);
        assert_eq!(size_of::<PxConvexMeshDesc>(), 48);
        assert_eq!(size_of::<PxTriangleMeshDesc>(), 40);
        assert_eq!(size_of::<PxTetrahedronMeshDesc>(), 36);
        assert_eq!(size_of::<PxSoftBodySimulationDataDesc>(), 12);
        assert_eq!(size_of::<PxBVH34MidphaseDesc>(), 12);
        assert_eq!(size_of::<PxMidphaseDesc>(), 16);
        assert_eq!(size_of::<PxBVHDesc>(), 24);
        assert_eq!(size_of::<PxCookingParams>(), 56);
        assert_eq!(size_of::<PxDefaultMemoryOutputStream>(), 20);
        assert_eq!(size_of::<PxDefaultMemoryInputData>(), 16);
        assert_eq!(size_of::<PxDefaultFileOutputStream>(), 8);
        assert_eq!(size_of::<PxDefaultFileInputData>(), 12);
        assert_eq!(size_of::<PxJoint>(), 16);
        assert_eq!(size_of::<PxSpring>(), 8);
        assert_eq!(size_of::<PxDistanceJoint>(), 16);
        assert_eq!(size_of::<PxJacobianRow>(), 48);
        assert_eq!(size_of::<PxContactJoint>(), 16);
        assert_eq!(size_of::<PxFixedJoint>(), 16);
        ...
        assert_eq!(size_of::<PxPrismaticJoint>(), 16);
        assert_eq!(size_of::<PxRevoluteJoint>(), 16);
        assert_eq!(size_of::<PxSphericalJoint>(), 16);
        assert_eq!(size_of::<PxD6JointDrive>(), 16);
        assert_eq!(size_of::<PxD6Joint>(), 16);
        assert_eq!(size_of::<PxGearJoint>(), 16);
        assert_eq!(size_of::<PxRackAndPinionJoint>(), 16);
        ...
        assert_eq!(size_of::<PxMeshOverlapUtil>(), 1036);
        ...
        assert_eq!(size_of::<PxPoissonSampler>(), 4);
        assert_eq!(size_of::<PxTriangleMeshPoissonSampler>(), 4);
        assert_eq!(size_of::<PxTetrahedronMeshExt>(), 1);
        assert_eq!(size_of::<PxRepXObject>(), 16);
        assert_eq!(size_of::<PxRepXInstantiationArgs>(), 12);
    }
}
